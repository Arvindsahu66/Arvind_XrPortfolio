...
function About() {
  return (
    ...
    >
      ...
      >
        <div>
          Hello! I&apos;m Arvind Kumar Sahu, a passionate Software Developer and problem
          solver. Currently, I&apos;m the Tech Team Lead at Infosys Global Hack 2k25, President of Club Multimedia, Nist University, Berhampur, India, with an expected
          graduation year of 2026. I&apos;m a software developer with experience
          in TypeScript, TailwindCSS, JavaScript, Unity, C#, Game Development, AR, VR, 3D development. I specialize in frameworks
        ...
        <div className="w-fit break-words">
          <Link
            href="mailto:arvindsahu9149@gmail.com"
            target="_blank"
            rel="noreferrer"
        ...
        <Link
          href="document/Arvind_Resume_1.pdf"
          target="_blank"
          rel="noreferrer"
          className="w-fit"
        >
